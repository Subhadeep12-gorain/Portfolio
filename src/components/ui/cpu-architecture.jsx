...
const CpuArchitecture = ({
  ...
  return (
    ...
    >
      ...
      {/* 1. Blue Light (Redefined to soft white-pink) */}
      ...
      {/* 2. Yellow Light (Redefined to soft pink-rose) */}
      ...
      {/* 3. Pinkish Light (Redefined to rose-pink) */}
      ...
      {/* 5. Green Light (Redefined to soft pink) */}
      ...
      {/* 6. Orange Light (Redefined to soft white-rose) */}
      ...
      {/* 7. Cyan Light (Redefined to rose-pink) */}
      ...
      {/* 8. Rose Light (Redefined to soft pink-white) */}
      ...
      <g>
        ...
        <text
          ...
          y="52"
          fontSize="5"
          fill={animateText ? "url(#cpu-text-gradient)" : "#ffdee3"}
          fontWeight="600"
          letterSpacing="0.1em"
        >
          {text}
      ...
      <defs>
        ...
        {/* Sakura Nocturne Custom Gradients */}
        <radialGradient id="cpu-blue-grad" fx="1">
          <stop offset="0%" stopColor="#ffffff" />
          <stop offset="50%" stopColor="#ffdee3" />
          <stop offset="100%" stopColor="transparent" />
        </radialGradient>
        <radialGradient id="cpu-yellow-grad" fx="1">
          <stop offset="0%" stopColor="#ffdee3" />
          <stop offset="50%" stopColor="#fbb3c1" />
          <stop offset="100%" stopColor="transparent" />
        </radialGradient>
        ...
        <radialGradient id="cpu-white-grad" fx="1">
          <stop offset="0%" stopColor="#ffffff" />
          <stop offset="60%" stopColor="#ffdee3" />
          <stop offset="100%" stopColor="transparent" />
        </radialGradient>
        ...
        <radialGradient id="cpu-cyan-grad" fx="1">
          <stop offset="0%" stopColor="#fbb3c1" />
        ...
        >
          ...
          >
            {animateMarkers && (
              <animate attributeName="r" values="0; 2.2; 1.8" dur="0.5s" />
            )}
          </circle>
        </marker>
        ...
        <linearGradient
          ...
          y2="1"
        >
          <stop offset="0%" stopColor="rgba(251, 179, 193, 0.45)" />
          <stop offset="60%" stopColor="#1e2024" />
        </linearGradient>
        {/* CPU Text Gradient */}
        <linearGradient id="cpu-text-gradient" x1="0" y1="0" x2="1" y2="0">
          <stop offset="0%" stopColor="#9e8c8f">
            <animate
          ...
          <stop offset="25%" stopColor="#ffdee3">
            <animate
              attributeName="offset"
              values="-1; 0; 1"
              dur="5s"
          ...
          <stop offset="50%" stopColor="#9e8c8f">
            <animate
              attributeName="offset"
              values="0; 1; 2;"
              dur="5s"
